...
Screen::Screen(StateMachine& machine, sf::RenderWindow& window, Resources& resources, const bool replace)
...
void Screen::pause()
{
    //std::cout << "Screen Pause" << std::endl;;
}

void Screen::resume()
{
    //std::cout << "Screen Resume" << std::endl;;
}
