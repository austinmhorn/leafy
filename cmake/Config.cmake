...
elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    set(LEAFY_OS_UNIX 1)
    if(ANDROID)
        set(LEAFY_OS_ANDROID 1)
        # use the OpenGL ES implementation on Android
        set(OPENGL_ES 1)
    else()
        set(LEAFY_OS_LINUX 1)
        # don't use the OpenGL ES implementation on Linux
        set(OPENGL_ES 0)
    endif()
elseif(CMAKE_SYSTEM_NAME MATCHES "^k?FreeBSD$")
    set(LEAFY_OS_FREEBSD 1)
    # don't use the OpenGL ES implementation on FreeBSD
    set(OPENGL_ES 0)
elseif(CMAKE_SYSTEM_NAME MATCHES "^OpenBSD$")
    set(LEAFY_OS_OPENBSD 1)
    # don't use the OpenGL ES implementation on OpenBSD
    set(OPENGL_ES 0)
elseif(CMAKE_SYSTEM_NAME MATCHES "^NetBSD$")
    set(LEAFY_OS_NETBSD 1)
...
elseif(${CYGWIN})
    message(FATAL_ERROR "Unfortunately LEAFY doesn't support Cygwin's 'hybrid' status between both Windows and Linux derivatives.\nIf you insist on using the GCC, please use a standalone build of MinGW without the Cygwin environment instead.")
else()
...
set(LEAFY_PKGCONFIG_DIR "/${CMAKE_INSTALL_LIBDIR}/pkgconfig")

if(LEAFY_OS_FREEBSD OR LEAFY_OS_OPENBSD OR LEAFY_OS_NETBSD)
    set(LEAFY_PKGCONFIG_DIR "/libdata/pkgconfig")
endif()
...
if(MSVC)
    set(LEAFY_COMPILER_MSVC 1)

    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        set(LEAFY_COMPILER_CLANG_CL 1)
    endif()
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    set(LEAFY_COMPILER_CLANG 1)
elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
    set(LEAFY_COMPILER_GCC 1)

    execute_process(COMMAND "${CMAKE_CXX_COMPILER}" "--version" OUTPUT_VARIABLE GCC_COMPILER_VERSION)
    string(REGEX MATCHALL ".*(tdm[64]*-[1-9]).*" LEAFY_COMPILER_GCC_TDM "${GCC_COMPILER_VERSION}")
else()
